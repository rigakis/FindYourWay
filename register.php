	...
	<main class="mdl-layout__content">
		<div class="mdl-card mdl-shadow--6dp">
			<div class="mdl-card__title mdl-color--primary mdl-color-text--white">
				<h2 class="mdl-card__title-text">Εγγραφή μέλους</h2>
			</div>
	  		<div class="mdl-card__supporting-text">
				<form method="post" id="register-form" action="#">
					...
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
						<input id="fullname" name="fullname" class="mdl-textfield__input" required type="fullname">
						<label class="mdl-textfield__label" for="fullname">Ονοματεπώνυμο</label>
					</div>
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
						<input id="email" name="email" class="mdl-textfield__input" required type="email">
					...
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
						...
						<label class="mdl-textfield__label" for="passwordagain">Επαλήθευση κωδικού</label>
					</div>
					<div id="response"></div>
					<div class="mdl-card__actions mdl-card--border" style="text-align: center;">
						<a href="login.html" class="mdl-button mdl-js-button mdl-button--primary">Είσοδος</a>
						<button type="submit" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--primary">
							<i class="material-icons">group_add</i> Εγγραφή
						</button>
					</div>
				</form>
			</div>
