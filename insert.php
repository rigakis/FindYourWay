	...
	<main class="mdl-layout__content">
		<div class="mdl-card mdl-shadow--6dp">
			<div class="mdl-card__title mdl-color--primary mdl-color-text--white">
				<h2 class="mdl-card__title-text">Εισαγωγή Επιχείρησης</h2>
			</div>
	  		<div class="mdl-card__supporting-text">
				<form  accept-charset="utf-8" method="post" id="insert-form" action=""  enctype="multipart/form-data">
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
						<input id="company_name" name="company_name" class="mdl-textfield__input" type="text" required>
            ...
            <select class="mdl-selectfield__select" id="type" multiple="multiple" size="10" name="type[] required">
              <option value=""></option>
            </select>
					</div>
					<div id="autocompletewrap" class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
      					<input id="autocomplete" name="autocomplete" class="mdl-textfield__input" type="text" required>
						<label class="mdl-textfield__label" for="autocomplete">Διέυθυνση</label>
					</div>
					<style>
						#addresswrap{display: none;}
					</style>
					<div id="addresswrap" class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" required>
						<input id="route" name="route" class="mdl-textfield__input" type="text" required>
						<label class="mdl-textfield__label" for="route">Διέυθυνση</label>
					</div>
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
						<input id="street_number" name="street_number" class="mdl-textfield__input" type="text" required>
						<label class="mdl-textfield__label" for="street_number">Αριθμός</label>
					</div>
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
						<input id="locality" name="locality" class="mdl-textfield__input" type="text" required>
						<label class="mdl-textfield__label" for="locality">Πόλη</label>
					</div>
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
						<input id="postal_code" name="postal_code" class="mdl-textfield__input" type="text" required>
						<label class="mdl-textfield__label" for="postal_code">Τ.Κ.</label>
					</div>
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
						<input id="county" name="county" class="mdl-textfield__input" type="text" required>
						<label class="mdl-textfield__label" for="county">Νομός</label>
					</div>
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
						<input id="lat" name="lat" class="mdl-textfield__input" type="text" required>
						<label class="mdl-textfield__label" for="lat">Γεωγραφικό πλάτος</label>
					</div>
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
						<input id="lng" name="lng" class="mdl-textfield__input" type="text" required>
						<label class="mdl-textfield__label" for="lng">Γεωγραφικό μήκος</label>
					</div>
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
						<input id="photo_name" name="photo_name" class="mdl-textfield__input" type="file" required>
